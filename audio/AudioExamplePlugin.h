...
class AudioExamplePluginContent;
namespace LmCdl {
class I_AudioApi;
class I_VcsiApplicationApi;
}

class AudioExamplePlugin : public QObject, public LmCdl::I_Plugin {
    Q_OBJECT
...
private:
    Q_DISABLE_COPY(AudioExamplePlugin)

    LmCdl::I_AudioApi* audioApi_;
    LmCdl::I_VcsiApplicationApi* applicationApi_;

    QScopedPointer<AudioExamplePluginContent> pluginContent_;
};
