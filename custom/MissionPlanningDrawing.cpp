...
const QSet<LmCdl::I_VectorDataPointDrawing *> &MissionPlanningDrawing::pointDrawings(const QGeoRectangle &area) const {
    return points_;
}

const QSet<LmCdl::I_VectorDataLineDrawing *> &MissionPlanningDrawing::lineDrawings(const QGeoRectangle &area) const {
    return lines_;
}

const QSet<LmCdl::I_VectorDataPolygonDrawing *> &MissionPlanningDrawing::polygonDrawings(const QGeoRectangle &area) const {
    return polygons_;
}
...
void MissionPlanningDrawing::addPolygons(QList<MissionPlanningPolygon*> polygons) {
...
bool MissionPlanningDrawing::visible() const { return true; }
